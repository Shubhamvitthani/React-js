...
import { getProductsAxios } from '../Reducer/axiosSlice';
import '../App.css'; // or wherever your CSS is

const AxiosProducts = () => {
    const dispatch = useDispatch();
    const { products, loading } = useSelector((state) => state.axiosProducts);
    ...
    return (
        <div className="container my-4">
            <h4 className="text-center mb-4">🚀 Products (using Axios)</h4>
            <div className="row">
                {loading ? (
                    <p>Loading...</p>
                ) : (
